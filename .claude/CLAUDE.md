...
- **LLMs:** Claude Sonnet 4 (steps s1,s3-s8), Gemini 2.5 Pro (s2 market analysis), Gemini text-embedding-004 (768-dim embeddings)
...
Per-step model assignment with abstract `LLMProvider` interface. Providers: `claude.py`, `gemini.py`, `openai_provider.py`.
